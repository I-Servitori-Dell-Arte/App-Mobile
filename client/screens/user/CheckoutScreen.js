  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.bodyContainer} nestedScrollEnabled={true}>
        <Text style={styles.primaryText}>Riepilogo ordine</Text>
        <ScrollView
        ...
        <Text style={styles.primaryText}>Totale</Text>
        <View style={styles.totalOrderInfoContainer}>
          <View style={styles.list}>
            <Text>Ordine</Text>
            <Text>{totalCost},00 €</Text>
          </View>
          <View style={styles.list}>
            <Text>Delivery</Text>
            <Text>{deliveryCost},00 €</Text>
          </View>
          <View style={styles.list}>
            <Text style={styles.primaryTextSm}>Totale</Text>
            <Text style={styles.secondaryTextSm}>
              {totalCost + deliveryCost},00 €
            </Text>
          </View>
        </View>
        <Text style={styles.primaryText}>Contatti</Text>
        <View style={styles.listContainer}>
          ...
          <View style={styles.list}>
            <Text style={styles.secondaryTextSm}>Cellulare</Text>
            <Text style={styles.secondaryTextSm}>+39 3313869850</Text>
          </View>
        </View>
        <Text style={styles.primaryText}>Indirizzo</Text>
        <View style={styles.listContainer}>
          <TouchableOpacity
            style={styles.list}
            onPress={() => setModalVisible(true)}
          >
            <Text style={styles.secondaryTextSm}>Indirizzo</Text>
            <View>
              {country || city || streetAddress != "" ? (
                ...
                <Text style={styles.primaryTextSm}>Aggiungi</Text>
              )}
            </View>
          </TouchableOpacity>
        </View>
        <Text style={styles.primaryText}>Pagamento</Text>
        <View style={styles.listContainer}>
          <View style={styles.list}>
            <Text style={styles.secondaryTextSm}>Metodo</Text>
