        ...
        if (result.success == true) {
          ...
          setData([
            ...
            },*/
            {
              id: 2,
              title: "Tessere",
              value: result.data?.tessereCount,
              iconName: "card",
              type: "secondary",
              screenName: "viewtessere",
            },
            {
              id: 3,
              title: "Prodotti",
    ...
    <InternetConnectionAlert onChange={(connectionState) => {}}>
      <View style={styles.container}>
        ...
        <View style={styles.headingContainer}>
          ...
          <Text style={styles.headingText}>Benvenuto, Admin</Text>
        </View>
        ...
        <View style={styles.headingContainer}>
          <MaterialCommunityIcons name="menu-right" size={30} color="black" />
          <Text style={styles.headingText}>Azioni</Text>
        </View>
        <View style={{ flex: 1, width: "100%" }}>
          <ScrollView style={styles.actionContainer}>
            ...
            <OptionList
              ...
              iconName={"card"}
              onPress={() =>
                navigation.navigate("viewtessere", { authUser: user })
              }
              type="morden"
            />
            <OptionList
