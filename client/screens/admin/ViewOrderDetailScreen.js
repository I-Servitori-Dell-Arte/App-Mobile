  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.screenNameContainer}>
        <View>
          <Text style={styles.screenNameText}>Dettagli ordine</Text>
        </View>
        <View>
          <Text style={styles.screenNameParagraph}>
            Vedi tutti i dettagli sull'ordine
          </Text>
        </View>
      </View>
      ...
      >
        <View style={styles.containerNameContainer}>
          <View>
            <Text style={styles.containerNameText}>Spedizione e fatturazione a</Text>
          </View>
        </View>
        ...
        <View>
          <Text style={styles.containerNameText}>Info ordine</Text>
        </View>
        <View style={styles.orderInfoContainer}>
          <Text style={styles.secondarytextMedian}>
            Ordine # {orderDetail?.orderId}
          </Text>
          <Text style={styles.secondarytextSm}>
            Acquistato il {dateFormat(orderDetail?.updatedAt)}
          </Text>
