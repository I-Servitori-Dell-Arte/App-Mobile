  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.screenNameContainer}>
        <View>
          <Text style={styles.screenNameText}>Dashboard Ordini</Text>
        </View>
        <View>
          <Text style={styles.screenNameParagraph}>Vedi tutti gli ordini</Text>
        </View>
      </View>
      ...
      >
        {foundItems && foundItems.length == 0 ? (
          <Text>{`Nessuno ordine trovato con # ${filterItem}!`}</Text>
        ) : (
